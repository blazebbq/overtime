...
export default function AdminOvertimePostsPage() {
  ...
  const loadPosts = async () => {
    ...
    setError(null);
    try {
      const res = await fetch("/api/admin/overtime-posts");
  ...
  return (
    <>
      ...
      <main className="p-4 max-w-7xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-white">All Overtime Posts - Admin View</h1>
          <p className="text-zinc-400">View all overtime opportunities and their applications (unrestricted access)</p>
        </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="bg-zinc-700/50 p-3 rounded-lg">
                      ...
                      <div className="text-2xl font-bold text-purple-400">{slotsAvailable}</div>
                    </div>
                  </div>

                  <Link
                    href={`/admin/overtime-posts/${post.id}`}
                    className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold transition-colors"
                  >
