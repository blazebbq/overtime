...
export default function ManagerApprovalsPage() {
  ...
  const loadApplications = async () => {
    ...
    setError(null);
    try {
      const res = await fetch("/api/manager/application-approvals?status=PENDING_APPROVAL");
    ...
    <>
      ...
      <main className="p-4 max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-zinc-400">Review and approve overtime applications from your team</p>
        </div>
